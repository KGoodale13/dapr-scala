...
final case class RetryPolicy(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.Message[RetryPolicy] with scalapb.lenses.Updatable[RetryPolicy] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): io.dapr.RetryPolicy = {
    ...
    def withThreshold(__v: _root_.scala.Int): RetryPolicy = copy(threshold = __v)
    def withPattern(__v: _root_.scala.Predef.String): RetryPolicy = copy(pattern = __v)
    ...
    def clearInterval: RetryPolicy = copy(interval = _root_.scala.None)
    def withInterval(__v: com.google.protobuf.duration.Duration): RetryPolicy = copy(interval = Option(__v))
    ...
    def companion = io.dapr.RetryPolicy
}

object RetryPolicy extends scalapb.GeneratedMessageCompanion[io.dapr.RetryPolicy] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[io.dapr.RetryPolicy] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): io.dapr.RetryPolicy = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[io.dapr.RetryPolicy] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = DaprcommonProto.javaDescriptor.getMessageTypes.get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = DaprcommonProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = io.dapr.RetryPolicy(
    threshold = 0,
    pattern = "",
    interval = _root_.scala.None
  )
  implicit class RetryPolicyLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, io.dapr.RetryPolicy]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, io.dapr.RetryPolicy](_l) {
  ...
  ): _root_.io.dapr.RetryPolicy = _root_.io.dapr.RetryPolicy(
    threshold,
    pattern,
    interval
  )
